...
* @section Libraly
* @subsection Sets
* Добро пожаловать в документацию библиотеки "SetC", высокопроизводительной библиотеки C для работы с числовыми множествами. 
...
* Библиотека SetC оптимизирована для работы с большими множествами данных, обеспечивая высокую скорость выполнения операций.
* Документация структурирована для удобства навигации.  Она разделена на несколько разделов, охватывающих все аспекты использования библиотеки.
* Каждый раздел содержит подробное описание соответствующих функций, их параметров и возвращаемых значений, а также иллюстрирующие примеры кода.
*/
#include <stdint.h>
#include <stdio.h>
#include <stdlib.h>
